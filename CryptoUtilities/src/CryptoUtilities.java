...
public final class CryptoUtilities {
    ...
    public static void reduceToGCD(NaturalNumber n, NaturalNumber m) {
        ...
        if (!m.isZero()) {
            ...
            temp.transferFrom(temp.divide(m));
            reduceToGCD(m, temp);
            n.transferFrom(m);
        }
    ...
    public static boolean isEven(NaturalNumber n) {
        ...
        NaturalNumber temp = new NaturalNumber2(n);
        temp.transferFrom(temp.divide(two));
    ...
    public static void powerMod(NaturalNumber n, NaturalNumber p,
        ...
        /*
         * checks the case of power zero
         */
        if (p.isZero()) {
            n.power(0);
            /*
             * checks the case of power of 2
             */
        } else if (p.compareTo(two) == 0) {
    ...
    public static boolean isWitnessToCompositeness(NaturalNumber w,
        ...
        /*
         * checks the w ^ 2 mod n = 1 formula
         */
        powerMod(temp, two, n);
        ...
        temp.copyFrom(w);
        /*
         * checks the w ^ (n-1) n!= 1 formula
         */
        tempN.subtract(one);
        powerMod(temp, tempN, n);
    ...
    public static boolean isPrime2(NaturalNumber n) {
        ...
        boolean result = true;
        /*
         * Declaring numbers to use as NaturalNumbers
         */
        NaturalNumber fourty = new NaturalNumber2(40);
        NaturalNumber ten = new NaturalNumber2(10);
        NaturalNumber numCandidates = new NaturalNumber2(randomNumber(fourty));
        numCandidates.add(ten);
        NaturalNumber randomWitness = new NaturalNumber2(0);

        NaturalNumber i = new NaturalNumber2(1);
        while (i.compareTo(numCandidates) < 0) {
            /*
             * creates the random candidates
             */
            randomWitness.transferFrom(randomNumber(fourty));
            randomWitness.add(ten);

            if (isWitnessToCompositeness(randomWitness, n)) {
                result = false;
            }
            i.increment();
        }
