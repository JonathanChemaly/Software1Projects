...
public final class StringReassembly {
    ...
    public static String combination(String str1, String str2, int overlap) {
        ...
        String result = "";
        //creates a string from the overlap between both strings
        result = str1.substring(0, str1.length() - overlap);
        result += str2;
    ...
    public static void addToSetAvoidingSubstrings(Set<String> strSet,
        ...
        //builds a new set to replace the old one with no substrings
        strSet.add(str);
    ...
    public static Set<String> linesFromInput(SimpleReader input) {
        ...
        //checks if it is at the end of a stream
        while (!input.atEOS()) {
            addToSetAvoidingSubstrings(result, input.nextLine());
        }
