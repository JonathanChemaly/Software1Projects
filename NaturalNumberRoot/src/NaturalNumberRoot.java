...
public final class NaturalNumberRoot {
    ...
    public static void root(NaturalNumber n, int r) {
        ...
        guess.divide(two);
        NaturalNumber test = new NaturalNumber2(tooHigh);
        test.subtract(lowEnough);

        //Continues to loop until the difference between tooHigh and lowEnough is 1
        while (test.compareTo(one) > 0) {
            ...
            //changes test and guess to the correct values after possible
            //changes occurred in the if or else statement
            test.copyFrom(tooHigh);
            test.subtract(lowEnough);
